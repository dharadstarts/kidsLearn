...
class _stateCatergoyDetailListScreen extends State<CategoryDetailListScreen> {
  ...
  void _navigateToItemScreen(int index, List<CategoryItem> currentItems) {
    if (widget.screenType == "drawing") {
      // Navigate to LetterDrawingScreen for drawing
      ...
      // Navigate to CategoryItemViewScreen for regular viewing
      Navigator.of(context).push(
        MaterialPageRoute(
                            ...
                            children: [
                              GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  if (widget.screenType == "drawing") {
                                    return LetterCategoryCard(
                                      index: index,
                                      size: gridItemWidth,
                                      categoriesDetailList: category,
                                      onTap: (i) {
                                        _navigateToItemScreen(i, currentItems);
                                      },
                                    );
                                  } else {
